              ...
              child: Column(
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    crossAxisAlignment: WrapCrossAlignment.center,
                    children: [
                      DropdownButton<AnomalyGranularity>(
                        value: _granularity,
                        items: const [
                          DropdownMenuItem(
                            value: AnomalyGranularity.daily,
                            child: Text('Daily'),
                          ),
                          DropdownMenuItem(
                            value: AnomalyGranularity.weekly,
                            child: Text('Weekly'),
                          ),
                          DropdownMenuItem(
                            value: AnomalyGranularity.monthly,
                            child: Text('Monthly'),
                          ),
                        ],
                        onChanged: (v) => setState(
                          () => _granularity = v ?? AnomalyGranularity.daily,
                        ),
                      ),
                      Text('Window: $_window'),
                      Slider(
                      ...
                      Text('Sensitivity: ${_threshold.toStringAsFixed(1)}'),
                      Slider(
                        value: _threshold,
                        min: 2.5,
                        max: 6.0,
                  ...
                  const SizedBox(height: 6),
                  Text('Anomalies found: ${anomalies.length}'),
                  if (anomalies.isNotEmpty) ...[
                    ...
                    ...anomalies
                        ...
                        .map(
                          (a) => Text(
                            '${formatPrettyDate(a.date)} • ${formatCurrency(a.value)} (z ${a.z.toStringAsFixed(1)})',
                          ),
                        ),
                  ],
                ],
